...
#define SPANSION_STS_PROTECT_BITS	(BIT5| BIT4| BIT3| BIT2)
#define SPANSION_STS_QUAD_MODE_BIT	(BIT6)
#define SPANSION_STS_WR_STS_DISABLE_BIT	(BIT7)
...
extern char *span_er_string[S25_MAX_ERASE_TYPE];
extern char *span_wr_string[S25_MAX_WRITE_TYPE];
extern char *span_rd_string[S25_MAX_READ_TYPE];
